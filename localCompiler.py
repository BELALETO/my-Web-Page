...
def compile_and_run(cpp_file, output_executable, input_file=None):
    # Compile the C++ file
...
def compare_outputs(cpp_file_1, cpp_file_2, output_executable_1, output_executable_2, input_file=None):
    # Compile and run the first C++ program
    output_1 = compile_and_run(cpp_file_1, output_executable_1, input_file)
    
    # Compile and run the second C++ program
    output_2 = compile_and_run(cpp_file_2, output_executable_2, input_file)
